...
function recuperationRecompense(lienRecompense){
  document.getElementById('afficheImage').src =  `../Image/Objectif/` + lienRecompense;
  document.getElementById('lienImage').value =  `../Image/Objectif/` + lienRecompense;
};
