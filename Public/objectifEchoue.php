        ...
        <section class="sectionUnique">
            ...
            <?php
                echo'
                    ...
                    <p class="etatDureeObjectif sousTitre">'."Cet objectif n'a pas été terminé avant la fin de la durée".'</p>
                ';
            ?>
            <div class="espaceBlanc30"></div>
            <img class="validation annule" src="../SVG/boutonAnnuler.svg">
            <div class="espaceBlanc30"></div>
            <?php
                if(listeJetonPourObjectif($_SESSION['objectifEnCours']) != FALSE){
            ...
            <form action="" method="POST">
                    <input type="submit" name="boutonRecompense" value="Récompense">
            </form>
        </section>
    </body>
